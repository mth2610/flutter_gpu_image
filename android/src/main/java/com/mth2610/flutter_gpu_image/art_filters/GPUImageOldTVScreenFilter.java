...
public class GPUImageOldTVScreenFilter extends GPUImage3x3TextureSamplingFilter2  {
    public static final String FRAGMENT_SHADER = "" +
            ...
            "       pixval+= texture2D(inputImageTexture, ipos)*mat[x][y];"+
            "       csum+= mat[x][y];"+
            "   }"+
            "}"+
            "   return pixval/csum;"+
            ...
            "   uv1 = mod(uv1, 1.);"+
            "   uv2 = mod(uv2, 1.);"+
            "   vec4 embc = texture2D(inputImageTexture,uv2) - texture2D(inputImageTexture,uv1);"+
            ...
            "   im = mix(im, noise1conv(noise_convm, gl_FragCoord.xy), noise1_b);"+
            "   float noise2_b = harms(noise2_freq, noise2_amp, noise2_threshold)*(noise2_max-noise2_min)+noise2_min;"+
            "   im = mix(im, noise2conv(noise_convm, gl_FragCoord.xy), noise2_b);"+
    ...
    public GPUImageOldTVScreenFilter() {
