...
public class GPUImageSnowFilter extends GPUImage3x3TextureSamplingFilter2  {
    public static final String PRIORITYMAP_FRAGMENT_SHADER = "" +
            ...
            "const float K = float( 0.142857142857 );" +
            "const float K2 = float( 0.0714285714285 );" +
            "const float jitter = float( 0.8 );" +
            ...
            "   outCol += textureColor;"+
            "   outCol += vec4(Snowout*0.9, Snowout, Snowout*1.1, Snowout);"+
            "   gl_FragColor = outCol;"+
            "}";
...
//        });
    ...
    private GPUImageSnowFilter(final float[] convolutionKernel) {
