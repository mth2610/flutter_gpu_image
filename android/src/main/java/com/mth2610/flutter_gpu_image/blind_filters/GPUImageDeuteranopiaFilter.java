...
public class GPUImageDeuteranopiaFilter extends GPUImage3x3TextureSamplingFilter2  {
    public static final String FRAGMENT_SHADER = "" +
            ...
            "   vec3 c_r = vec3(62.5, 37.5, 0);"+
            "   vec3 c_g = vec3(70, 30, 0);"+
            "   vec3 c_b = vec3(0, 30, 70);"+
            "   c_r /= 100.0;"+
            "   c_g /= 100.0;"+
            "   c_b /= 100.0;"+
    ...
    public GPUImageDeuteranopiaFilter() {
