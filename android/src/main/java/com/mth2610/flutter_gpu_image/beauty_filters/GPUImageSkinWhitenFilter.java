...
public class GPUImageSkinWhitenFilter extends GPUImage3x3TextureSamplingFilter2  {
    public static final String PRIORITYMAP_FRAGMENT_SHADER = "" +
            ...
            "   float texelWidthOffset = resolution.x;"+
            "   float texelHeightOffset = resolution.y;"+
            ...
            "   lowp float strength = -1.0 / 1000.0;"+
...
//        });
    ...
    private GPUImageSkinWhitenFilter(final float[] convolutionKernel) {
