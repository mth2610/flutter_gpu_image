...
public class GPUImageGlitchFilter extends GPUImage3x3TextureSamplingFilter2  {
    public static final String PRIORITYMAP_FRAGMENT_SHADER = "" +
            ...
            "   float time = mod(5.0*100.0, 32.0)/110.0;"+
            "   float GLITCH = 0.1 + 0.2;"+
...
//        });
    ...
    private GPUImageGlitchFilter(final float[] convolutionKernel) {
